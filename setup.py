...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            "<FORK-TECHNICAL-NAME> = chia.cmds.chia:main",
            "<FORK-TECHNICAL-NAME>_daemon = chia.daemon.server:main",
            "<FORK-TECHNICAL-NAME>_wallet = chia.server.start_wallet:main",
            "<FORK-TECHNICAL-NAME>_full_node = chia.server.start_full_node:main",
            "<FORK-TECHNICAL-NAME>_harvester = chia.server.start_harvester:main",
            "<FORK-TECHNICAL-NAME>_farmer = chia.server.start_farmer:main",
            "<FORK-TECHNICAL-NAME>_introducer = chia.server.start_introducer:main",
            "<FORK-TECHNICAL-NAME>_crawler = chia.seeder.start_crawler:main",
            "<FORK-TECHNICAL-NAME>_seeder = chia.seeder.dns_server:main",
            "<FORK-TECHNICAL-NAME>_timelord = chia.server.start_timelord:main",
            "<FORK-TECHNICAL-NAME>_timelord_launcher = chia.timelord.timelord_launcher:main",
            "<FORK-TECHNICAL-NAME>_full_node_simulator = chia.simulator.start_simulator:main",
        ]
    },
    package_data={
