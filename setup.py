...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            "venidium = chia.cmds.chia:main",
            "venidium_daemon = chia.daemon.server:main",
            "venidium_wallet = chia.server.start_wallet:main",
            "venidium_full_node = chia.server.start_full_node:main",
            "venidium_harvester = chia.server.start_harvester:main",
            "venidium_farmer = chia.server.start_farmer:main",
            "venidium_introducer = chia.server.start_introducer:main",
            "venidium_crawler = chia.seeder.start_crawler:main",
            "venidium_seeder = chia.seeder.dns_server:main",
            "venidium_timelord = chia.server.start_timelord:main",
            "venidium_timelord_launcher = chia.timelord.timelord_launcher:main",
            "venidium_full_node_simulator = chia.simulator.start_simulator:main",
        ]
    },
    package_data={
